...
## O3a. Doru & Donavich
As the players move to depart Vallaki for Castle Ravenloft on the day of the dinner, if they previously spared the **[Elite Vampire Servitor](https://2e.aonprd.com/Monsters.aspx?ID=3224)** Doru and aided him in overcoming his thirst for blood in [[Act I - Into the Mists/Arc B - Welcome to Barovia]], they encounter Doru and his father, the priest Donavich (using the statistics of an **[Priest of Sarenrae scaled down to Level 3](https://2e.aonprd.com/NPCs.aspx?ID=3445)**) at Vallaki’s eastern Morning Gate as they approach the Old Svalich Road. Read:
...
A player who succeeds a DC 23 Perception check to Sense Motive notices that Gorek appears somewhat uncertain about barring Doru entry. A player who points this out to him and succeeds on a DC 23 Diplomacy check can convince him to share his uncertain belief that, because Doru doesn’t seem to have any fangs, he might not be undead at all.
...
After a few minutes have passed, the great doors leading from <span class="citation">K7. Entry (p. 54)</span> open to reveal Diavola, an unhappy and soaking-wet **Barovian witch (use [Mythic Coven Aspirant scaled to Level 6](https://2e.aonprd.com/NPCs.aspx?ID=3535) stat block)**. You can add some Hexes from [Starless Shadow](https://2e.aonprd.com/Patrons.aspx?ID=17) patron.
...
> >
> > * **Hall of Bones.** This area is largely as described in <span class="citation">K67. Hall of Bones (p. 78)</span>. However, six **crawling claws** (you can fin a swarm option on Nethis **OR** you can use [Clacking Skull Swarm](https://2e.aonprd.com/Monsters.aspx?ID=1307)) have climbed into the jaw of Argynvost’s skull, and drop on any player from above to attack as soon as the player enters this chamber. The sound of fighting draws the attention of Rahadin, who swiftly confronts the players and escorts them to the guest suite.
> >
...
> >
> > * **Chamberlain’s Office.** This area is largely as described in <span class="citation">K72. Chamberlain’s Office (p. 79)</span>. However, while the player can catch brief and occasional glimpses of a moving shadow out of the corner of their eye, the **[Elite Invidiak (Shadow Demon)](https://2e.aonprd.com/Monsters.aspx?ID=599)** emerges only to attack any player who searches for a secret door.
>
> <br>
>
...
> >
> > * **King’s Accountant.** This area is largely as described in <span class="citation">K30. King’s Accountant (p. 62)</span>. However, Lief Lipsiege is a lawful neutral **[Wight](https://2e.aonprd.com/Monsters.aspx?ID=3239)** with no attacks. When the players first approach, notice, or interact with him, read:
> >
> > <hr>
> >
...
> >
> > * **5F. Familiar Room, Element Room & Cauldron.** If a player ascends an additional floor beyond the fourth-floor landing comprising <span class="citation">K47. Portrait of Strahd (p. 68)</span>, they emerge onto the fifth-floor landing leading to <span class="citation">K54. Familiar Room (p. 71)</span>.  The Familiar Room and the rooms beyond are largely as described in <span class="citation">K54. Familiar Room (p. 71)</span>, <span class="citation">K55. Element Room (p. 72)</span>, and <span class="citation">K56. Cauldron (p. 72)</span>. However, the Element Room contains a *[Fire Breath Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2941)* and two *[Elixirs of Life (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=3308)* hidden amongst the bottles and jars. In addition, there are no **Barovian witches** in the nearby <span class="citation">K56. Cauldron (p. 72)</span>, which is instead guarded by four **[Animated Brooms scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=2818)** leaning against the wall. The brooms animate and attack any intruders on sight, but won’t pursue any players who flee past the Familiar Room into <span class="citation">K48. Offstair (p. 70)</span>.
> >
...
> Players who cast *Talking Corpse* on Varushka's corpse can learn the same information as in [[#O8e. The Fifth Level]]. Varushka's corpse can also share that she committed suicide by hanging when she realized Strahd would never let her go free.
...
The man is a memory of Ismark Antonovich (Ismark the Great), and appears strangely familiar to any player who’s previously seen the statue of Ismark the Great in the Barovian village square. The raven on his shoulder is a memory of the **wereraven (he has [Master Of Disguise](https://2e.aonprd.com/NPCs.aspx?ID=3433) statblock with Wereraven attributes - give him Level 8 because of this  as you apply [Werecreature Template])** Livius Martikov, the founder of the Keepers of the Feather.
...
Ismark, who has the statistics of a **[Gendarme](https://2e.aonprd.com/NPCs.aspx?ID=3563)** and is a friendly, gregarious man, is willing to share the following information if asked:
...
* the four-poster bed (**large animated object**) - use [Animated Statue - make it Large](https://2e.aonprd.com/Monsters.aspx?ID=2820) scaled to the level of your liking,
* the two chairs (**medium animated objects**) - use [Animated Statue](https://2e.aonprd.com/Monsters.aspx?ID=2820) scaled to the level of your liking,
* the ottoman (**small animated object**), use [Animated Statue - make it Small](https://2e.aonprd.com/Monsters.aspx?ID=2820) scaled to the level of your liking, and
* the rug (**rug of smothering**) - use [Cloaker](https://2e.aonprd.com/Monsters.aspx?ID=82) scaled to the level of your liking

Make it at least **Moderate** encounter for your party plus two Level 8 allies.

I suggest the next **Severe+** alternative though:
- One rug [Cloaker scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=82) with a Construct trait;
- Two [Animated Armors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=2819);
- One chair [Mimic scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=300;
...
A character must succeed on DC 20 Acrobatics check to Balance successfully traverse the rooftop. A character who crawls, or who has a climbing speed, travels half as far but succeeds automatically as described <span class="citation">K53. Rooftop (p. 71)</span>.

A character who critically fails a Acrobatics check to Balance to traverse the roof more begins sliding toward the edge of the roof. If this occurs, the character can catch themselves on the edge of the roof by succeeding on a DC 20 Reflex saving throw or DC 20 Acrobatics check to [Grab an Edge](https://2e.aonprd.com/Actions.aspx?ID=2313), getting one degree of success better if they are secured to other characters by a rope or other means. On a failure, the character falls 15 feet to a ledge that runs beneath the edge of the roof. To climb back to the roof from the ledge, a character must succeed on a DC 20 Athletics check.

When all players have exited the window, six **[Vampire Bat Swarms scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=2848)** descend to attack any characters that haven't yet reached the far side. Characters have -3 Circumstance penalty on checks made to cross the roof while sharing a space with a swarm of bats.

On initiative count 20 of the first round after the **[Vampire Bat Swarm scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=2848)** descend, a **[Weak Adult Black Dragon](https://2e.aonprd.com/Monsters.aspx?ID=128)** begins stalking the players from <span class="citation">K47. Portrait of Strahd (p. 68)</span>. Read:
...
* A creature that critically fails its saving throw against the dragon's ***Frightful Presence*** aura is Paralyzed until the end of its next turn.
* A creature that fails its saving throw against the dragon's ***Breath Weapon*** takes no damage. Instead, the acid transforms into an writhing tangle of jewel-encrusted gold chains, which restrain the target until the end of its next turn. A creature that succeeds on its saving throw has its legs partially wrapped by the chains and recieves -10-feet penalty on all speeds.

A creature ensnared by the dragon's chains notices that they're not chains at all, but thousands of interlocking golden rings, bracelets, and necklaces. Each set of chains has AC 26, hardness 5, object immunities and weakness 5 to fire damage, and can be destroyed if receives 13 damage at once, broken with a successful DC 26 Athletics check and has a DC 26 for Escape attempts.

The dragon acts as follows:

**On its first turn**, it reaches the door, smashes it once and everyone start to make saves against its ***frightful presence*** aura, but it doesn't move through the door.

**On its second turn**, it spends one action to go through the widened guest suite door, then uses its ***Breath Weapon***, hitting any players less than halfway across the rooftop with a cone. Read:
...
**On its third turn**, the dragon exits the lounge and roars, shattering the glass in all windows around it. If its ***Breath Weapon*** has recharged, it uses it again in a usual 80-foot line way; otherwise, so it exists through the windows, then crawl across the rooftops until it reaches a target for its ***Draconic Frenzy*** attack, preferring to approach any characters that have fallen to the ledge below the roof.
...
> This memory of Strahd has the statistics of [Elite Vampire Mastermind](https://2e.aonprd.com/Monsters.aspx?ID=3226), but without the ***spellcasting*** feature, ***dominate*** feature, ***children of the night*** feature. In addition, Strahd is a **Mythic Brute** with two reactions instead of one. The reactions can be spent on **Reactive Strike** or **Mythic Ferocity**.
>
> If reduced to 0 hit points, Strahd uses his ***Mist Escape*** feature to transform into a cloud of mist. He then retreats through the crack in the wall described in <span class="citation">K63. Wine Cellar (p. 77)</span>.

Strahd doesn’t immediately notice players who merely peer into the room instead of entering it. In addition, while in the Nightmare, Strahd is bloodlusted and crazed with rage and grief. While in this state, he has -4 status penalty on Will saving throws.
...
The players can again attempt to persuade Varushka to free them by making any reasonable argument and succeeding on a DC 25 Diplomacy check. The check is made with -2 Circumstance penalty if the players failed the first Diplomacy check. Otherwise, the check is made with +2 Circumstance bonus if the players’ arguments directly rebut the Dark Powers’ whispers, and succeeds automatically if the players present Varushka with Katarina’s note or its contents.
...
* ***Element Room.*** The Element Room contains a *[Fire Breath Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2941)* and two *[Elixirs of Life (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=3308)* hidden amongst the bottles and jars. In addition, there are no **Barovian witches** in the nearby <span class="citation">K56. Cauldron (p. 72)</span>, which is instead guarded by four **[Animated Brooms scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=2818)** leaning against the wall. The brooms animate and attack any intruders on sight, but won’t pursue any players who flee past the Familiar Room into <span class="citation">K48. Offstair (p. 70)</span>.
...
The pouch contains a diamond ring with a gold band worth 250 gp.
...
The trapdoor exits into the Element Room, which is largely as described in <span class="citation">K55. Element Room (p. 72)</span>, except it also contains a [Fire Breath Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2941) and two *[Elixirs of Life (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=3308)*  hidden amongst the bottles and jars. There are no **Barovian witches** in the nearby <span class="citation">K56. Cauldron (p. 72)</span>, which is instead guarded by four  **[Animated Brooms scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=2818)** leaning against the wall. The brooms animate and attack any intruders on sight, but won’t pursue any players who flee past the Familiar Room into <span class="citation">K48. Offstair (p. 70)</span>.
...
***Milestone.*** Dining with Strahd and vanquishing Varushka completes a story milestone. When the players depart Ravenloft, award each player 250 XP.
