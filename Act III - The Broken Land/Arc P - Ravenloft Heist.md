...
* Viktor finds in the Khazan's spellbook a semi-dark ritual that involves Amber Shards. The mythic players can cast [Band Of Heroes](https://2e.aonprd.com/MythicRituals.aspx?ID=189) ritual. If they critically fail, the mythic points function as Hero Points for one day as they rupture their own connections to their amber powers. Primary DC is 29, while Secondary DC is 24.
* If no more than half of the party has progressed to Mythic Tier 4 (Hence changing them to look very noticebly Unholy), then Van Richten provides them with a special tome he worked on recently. [Van Richten's Undead Compendium](https://2e.aonprd.com/Equipment.aspx?ID=1576). (It should help balancing some tough amount of this Arc's fights)
* Suggest to players that they should buy some scrolls and other consumables to increase the amount of the resources as it's a very big dungeon. Also, it's worth buying an additional [Spacious Pouch (Type I)](https://2e.aonprd.com/Equipment.aspx?ID=3032).
...
>
> **Ismark Kolyanovich (Barovia).** Ismark is honored by the players’ request and eager to assist, but reluctant to give Strahd any further reason to punish the villagers of Barovia. Players who inform Ismark that they bear the *Holy Symbol of Ravenkind*, or who provide a robust plan to disguise his movements and identity from Strahd’s spies, can successfully convince Ismark to join them for the heist by succeeding on a DC 20 Diplomacy check, made with advantage if the players both inform Ismark of the *Holy Symbol of Ravenkind* and provide such a plan.
...
> **Muriel Vinshaw (Any).** Muriel is reluctant to venture into Ravenloft due to Davian’s orders and her grief over Elric’s death, though she is more than happy to meet the players with several **swarms of ravens** to assist their efforts to enter the castle. However, a player who promises Muriel an opportunity to obtain justice for Elric and succeeds on a DC 20 Diplomacy check can convince her to join the party in the castle as well.


> [!info]+ **Awareness Points (AP) tracking**
> I suggest using Awareness Points subsistem with the next modifications.
>
> - When a player fails a check to overcome a skill challenge, they get 1 AP (or 2 on a critical failure). For example, entering the castle might give 1 AP if they are not careful (failed checks or just something very visible) - or even 2 AP on critical failure (Per failed player!)
> - Players will receive 1 AP each 4 rounds of combat (on 5th rounds, 10th rounds, etc.). Maximum 3 AP per fight.
> - The players earn APs whenever their activities are disruptive enough to draw attention to the infiltration, subject to GM discretion. For example, they might trigger some traps (like elevator) and get 1 or even 2 AP.
>
> When the players reach certain thresholds, the complications occur as "Ravenloft/Rahadin" reacts to them and sends some monsters from the catacombs to the area where the players were heard the last time.
>
> - 5 APs: Rahadin gets suspicion. Increase the DCs for obstacles by 1. The first time the players reach this tier, skeletons are sent. Two Mythic Skeletal Champions scaled to Level 7 and two Mythic Elite Skeletal Mages.
> - 10 APs: The first time the players reach this tier, Three Mythic Ambushers - Weak Prowler Wights are sent. Ideally, they make an ambush by using their Feign Death ability.
> - 15 APs: Increase the DCs for obstacles by a total of 2, and the first time the players reach this tier, three Greater Hell Hounds scaled to Level 7 and Mythic Wight Commander scaled down to Level 10 manifests

> [!info]+ **LAY LOW (EXPLORATION)**
>
> You attempt to evade detection by concealing your presence or creating a diversion to throw pursuers off your trail. This activity requires 1 hour spent in hiding, creating false trails, or employing other evasive techniques.
>
> Each character (including allied NPCs) can attempt one skill check appropriate to their chosen evasion method: Stealth to hide, Deception to create a diversion, etc. The GM sets the DC for these checks according to the situation, with a standard DC of 24. The GM might adjust the difficulty based on the effectiveness of the chosen tactics or environmental conditions.
>
> These checks generate Victory Points named Subterfuge Points that represent your group's success at evading detection. Total all Subterfuge Points earned, then subtract 2 from that total for each previous Lay Low activity your group has attempted during the heist.
>
> - **Success**: If your group earns more Subterfuge Points than there are characters in your party, reduce your Awareness Points (AP) by 3.
> - **Partial Success**: If your group earns exactly as many Subterfuge Points as there are characters in your party, reduce your Awareness Points by 1.
> - **Critical Failure**: If your group earns no Subterfuge Points at all, increase your Awareness Points by 1d4 as your attempts to hide actually draw more attention to your presence.
...
> This smooth, polished, palm-sized stone is engraved with a carving of a circular, avian eye. While holding the stone to their eye or ear, the stone’s holder can use their action to whisper a location permitted by the _clairvoyance_ spell. The holder then gains the effects of the [Clairaudience](https://2e.aonprd.com/Spells.aspx?ID=1465) or [Clairvoyance](https://2e.aonprd.com/Spells.aspx?ID=1466) spell. While one active, you can't produce another. And you need to continue to hold it.
>
> The stone can be used to cast the _clair*_ spell three times. The third time the spell is cast, the stone crumbles to dust after the spell ends.
...
If any player succeed a DC 26 Perception check, add:

<div class="description">
<p>Two distant figures patrol the castle parapets immediately above the drawbridge.</p>
</div>

The figures are **[Hunter Wights](https://2e.aonprd.com/Monsters.aspx?ID=1915)**. (Because they’re patrolling the walls, the wights don’t notice the players immediately.)
## P2c. Strahd’s Departure
Approximately fifteen minutes after dusk, Strahd descends to <span class="citation">Crypt 39 (p. 93)</span> and retrieves Beucephalus from his crypt. Strahd then mounts the **Greater Nightmare**, flies it up <span class="citation">K18a. High Tower Shaft (p. 58)</span>, and emerges from <span class="citation">K59. High Tower Peak (p. 73)</span> into the skies above Ravenloft. Read:
...
* Magical flight to *fly* across the chasm
- Magical teleportation (e.g. *translocate*) to teleport across the chasm
...
> Six **[Hunter Wights](https://2e.aonprd.com/Monsters.aspx?ID=1915)** patrol the castle walls at all hours of the day and night. (See the diagram below for the wights’ locations and patrol routes along the castle walls, with each black shield representing a wight and each dotted black arrow marking that wight’s patrol route.)
>
> Each wight bears a large, recognizable horn carved from a dire wolf's femur, which can be visibly seen dangling from its belt. On a wight's second turn in combat, it uses its action to blow the horn, alerting all other wights to the presence of intruders. Once alerted, a wight uses its full movement to move in the direction of the horn. If an intruder is within range of its longbow, the wight shoots. Otherwise, it takes Stride actions to continue moving in the direction of the horn.
>
> Together, they are an Extreme encounter. Feel free to use [Cairn Wights scaled to Level 6](https://2e.aonprd.com/Monsters.aspx?ID=859) (some of them Elite)
>
> Give Cairn Wights longbows too.

![[Wight Patrols.png]]
One player must attempt a check with the DC appropriate for the task. Base DC is 26. Suggestions: DC 24 Stealth check, DC 26 Perception check, DC 28 Deception check, etc.

- **Failure**: The party gets 1 Awareness Point.
- **Critical Failure**: The party gets 2 Awareness Points, and the fight with the Wights is initiated.

Other characters can Aid the player by succeeding at a DC 20 check using any skills that seem appropriate for their check.

The players might use any of the following methods to distract the **wights** patrolling the area above the drawbridge:

- Magical illusions, obfuscation, or invisibility.
- Distracting decoys (e.g., swarms of ravens directed by Muriel, or summon spells)
- Any other reasonable method (e.g., waiting until both wights are facing away from the drawbridge)

Increase a degree of success for any Aid check when a levelled spell is used or something very effective occurs. (Like a raven distraction)
# P3. Castle Grounds
> [!abstract]+ **Varushka’s Gratitude**
> If the players reunited the spirit of Varushka with Katarina’s necklace in [[Arc O - Dinner with the Devil]], at a time of your choosing when the players are engaged in a combat encounter in Castle Ravenloft and at least two-thirds of them are bloodied, the spirit of Varushka appears to assist them in a show of gratitude. Varushka’s spirit, which uses the statistics of a **[Poltergeist scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3142)**, lingers for no more than 1 minute, and has the following additional properties:
>
> * She isn’t invisible, and instead has the appearance of a **[Elite Shadow](https://2e.aonprd.com/Monsters.aspx?ID=3186)** bearing the silhouette of a slender woman wearing a dress and apron. (Though she can’t speak with the players in this form, Varushka can communicate through simple nods and gestures.)
> * She gains the following additional reaction: ***Poltergeist’s Shield.*** In response to Varushka or a creature within 5 feet of her being targeted with a melee attack, Varushka gives +2 Circumstance bonus to the target’s AC against the triggering attack.
>
> Alternatively, she can be used in other non-combat situations to help the players to avoid getting an Awarness Point or she can make a diversion in the castle to help to reduce Awarness Points if the players taking a **Lay Low** activity.
...
>
> If Rahadin confronts the players in <span class="citation">K78. Brazier Room (p. 82)</span>, he removes the seven stones set into the brazier's rim and places them into a small leather pouch before they enter the room. He then ties the leather pouch to his belt. If the players notice the stones' disappearance before noticing Rahadin's _**screams of the dead**_, he emerges from his hiding place behind one of the iron golems and asks, "Looking for these?" A player can attempt to sever the pouch from Rahadin's belt by making an attack against Rahadin's AC and Critically Succeeding. On the critical hit, the pouch is severed if the string tying it to Rahadin's belt takes at least 1 point of piercing, slashing, fire, acid, necrotic, radiant, or force damage. Rahadin also automatically drops the pouch if he uses the _amulet of Ravenloft_ to pass through a wall, ceiling, or floor of the castle.
>
> See [[#South Crypts, Third Row]] for more information about Rahadin's statistics and appearance.

> [!info]+ **Heist Milestones**
> Stealing Argynvost's skull completes a story milestone. When the players depart Ravenloft, award each player 250 XP. Additional objectives:
>
> * obtain the *Icon of Dawn's Grace* from St. Markovia's crypt
...
> If the players haven't alerted the **wights** atop the walls yet, all them must succeed on a DC 26 Stealth check to Avoid Notice to evade detection each time they move across the grounds without pausing. If the players fail the check, the **wights** attack from atop the walls using their longbows, but don't follow the players into the castle.
...
These north and south courtyards are largely as described in <span class="citation">K2. Center Court Gate (p. 54)</span>. In addition, a creature that attempts to lift one of the portcullises in these areas must succeed on a DC 29 Stealth check to avoid alerting any **wights** nearby. The Athletics check is DC 25.
## P3c. Servants’ Courtyard
<span class="citation"><em>This scene takes place in Chapter 4, Area K3.</em></span>

This area is as described in <span class="citation">K3. Servants' Courtyard (p. 54)</span>. DC 22 Athletics check to Force Open.
...
If the players pass DC 26 Perception check to Search, they notice the windows.
...
This area is largely as described in K7. Entry (p. 54). However, there are only two **[Mythic Weak Young Red Dragon](https://2e.aonprd.com/Monsters.aspx?ID=136)** statues instead of four. Also, give them the next feature: **Surprise Attacker** On the first round of combat, creatures that haven't acted yet are [off-guard](https://2e.aonprd.com/Conditions.aspx?ID=58) to the flame drake. (As in the original campaign, the dragons only attack strangers leaving the castle, not entering it.)
...
This area is largely as described in <span class="citation">K8. Great Entry (p. 55)</span>, <span class="citation">K9. Guests’ Hall (p. 55)</span>, and <span class="citation">K19. Grand Landing (p. 58)</span>. However, reduce the number of **[Gargoyles scaled to Level 6](https://2e.aonprd.com/Monsters.aspx?ID=3001)** from eight to four.

> [!combat]+ **Balancing the Entryway**
> This combat encounter is a **Moderate+** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d'Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
>
> - **Three Players**. Reduce the number of gargoyles to three.
> - **Five Players**. Increase the number of gargoyles to five.
> - **Six Players**. Increase the number of gargoyles to six.

**_The First Visit._** The first time the players enter this area, a _glyph of warding (DC 33 to notice and [dispel magic](https://2e.aonprd.com/Spells.aspx?ID=78) (7th level, [counteract](https://2e.aonprd.com/Rules.aspx?ID=371) DC 33))_ hidden among the dust on the ceiling activates, casting a _[Illusory Scene (6th Rank)](https://2e.aonprd.com/Spells.aspx?ID=1570)_ spell originating from the organ in the K10. Dining Hall (p. 56). (The _[Illusory Scene](https://2e.aonprd.com/Spells.aspx?ID=1570)_ is the source of the “sad and majestic organ tones" described in K8. Great Entry (p. 55).)

Shortly after the players first enter this area, the _[Illusory Scene](https://2e.aonprd.com/Spells.aspx?ID=1570)_ abruptly changes. Read:
...
>Due to the phase mechanic, this combat encounter is a series of two consecutive **Moderate** combat encounters against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d'Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
>
> - **Three Players**. Make her first phase Weak.
> - **Five Players**. Make her second phase Elite.
> - **Six Players**. Make her both phases Elite.

In either case, on initiative count 20 of the first round of combat, the four **Gargoyles scaled to Level 6** begin to stir, rolling initiative and joining the fray on their turns. Use the statblock below for the gargoyles.

Ludmilla always casts _darkness_ (4th rank) with only 1 action on her first turn in combat. If the spell isn't countered and the _Holy Symbol of Ravenkind_ is visible, she then immediately uses her mythic _Misty Step_ reaction to teleport into the darkness, hiding ten feet above the player bearing the symbol. Ludmilla then uses her action to attempt to take the symbol from the player's person. (If the symbol isn't visible, Ludmilla immediately retreats to the chapel as described below, hoping to have the gargoyles weaken the players before entering combat herself.)

If Ludmilla isn't Hidden from the target, her attempt to take the _Holy Symbol of Ravenkind_ automatically fails (the player might have some additional feature for that to happen).
...
<p><strong><em>Lightning Lance.</em></strong> A bolt of lightning arcs toward a creature of Ludmilla’s choice that she can see within 30 feet. Two bolts then leap from that creature to as many as two other creatures, each of which must be within 10 feet of the first creature. (A creature can be targeted by only one of the bolts.) Each creature must make a <span class="highlight">DC 15 Reflex saving throw</span>, taking 9 (2d8) lightning damage on a failed save, or half as much damage on a success.</p>
<h3>Bonus Actions</h3>
...
The woman’s corpse is an illusion created by the _[Illusory Object 5th rank](https://2e.aonprd.com/Spells.aspx?ID=1569)_ spell, and resembles a nondescript Barovian woman in her twenties. If the players touch it or interact with it in any way, it vanishes. The events described in K10. Dining Hall (p. 56) following the illusion’s disappearance then occur, including the “fierce, bone-chilling wind," then occur. Read:
...
The secret door can be found with a DC 26 Perception check to Search.
...
This area is largely as described in K30. King’s Accountant (p. 62). However, Lief Lipsiege is a lawful neutral **[Wight](https://2e.aonprd.com/Monsters.aspx?ID=3239)** with no attacks. When the players first approach, notice, or interact with him, read:
...
A player can find the secret door described in <span class="citation">K27. King's Hall (p. 61)</span> behind the tapestry of King Barov and his army. The secret door can be found with a DC 26 Perception check to Search.
...
This area is largely as described in <span class="citation">K23. Servants' Entrance (p. 59)</span>. A DC 22 Athletics check is needed to Force Open. However, add the following to the end of this area's description:
...
Four puncture wounds disfigure the corpse’s neck. A player who succeeds on a DC 19 Medicine check learns that the corpse has been exsanguinated. (The corpse was left here by the two **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)** lurking in the [[#Wine Cellar]].)
### Servants’ Quarters
...
>
> A player who inspects the machinery here and succeeds on a DC 26 Crafting check discerns that the elevator has been reconfigured to be activated by a trigger mechanism elsewhere in the castle. A player who subsequently succeeds on a DC 30 Thievery or Crafting check can manually activate the elevator mechanism, causing the elevator to rise or descend to any accessible floor. (A player who activates the elevator in this way before entering it must succeed on a DC 26 Reflex saving throw to enter the elevator before it departs.)
...
> If the players ask Cyrus about his life at Castle Ravenloft or the Abbot’s “perfection" and mention Clovin, Otto, and Zygfrek Belview’s curiosity, Cyrus is initially reluctant to interrupt his cooking efforts to reply to them. If the players continue to press him for a response, however, and succeed on a DC 10 Diplomacy check, Cyrus pauses, sighs, and shakes his head before replying, “They’re good lads. Tell them I’m well and thriving."
>
...
#### The Ravenous Spawn
The first time any player approaches the doors to K67. Hall of Bones (p. 78) or K61. Elevator Trap (p. 74), the door leading to K61. Elevator Trap (p. 74) opens. An _[Phantasmal Minion](https://2e.aonprd.com/Monsters.aspx?ID=2750)_ carrying a crystal dinner bell then emerges from beyond the door, acting as described in Unseen Servant (p. 51).

When the dinner bell rings, the two **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)** lurking in [Kitchen](https://publish.obsidian.md/strahdreloaded-pf2e/Act+III+-+The+Broken+Land/Arc+P+-+Ravenloft+Heist#Kitchen) and [Butler’s Quarters](https://publish.obsidian.md/strahdreloaded-pf2e/Act+III+-+The+Broken+Land/Arc+P+-+Ravenloft+Heist#Butler’s Quarters) quietly scuttle across the 10-foot ceiling, attacking from above the following round. They roll Stealth for initiative.

> [!combat]- **Balancing the Ravenous Spawn**
> This combat encounter is a **Low+** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller, modify the encounter as follows:
> **Three Players**. Make them Weak.

The vampires prefer to target easy prey, including unarmored or surprised characters. Once a vampire has successfully grappled a target with its ***claws***, it attempts to drag (They can move with half speed with a Grabbed creature during the round if they spend **Mythic** point) its prey away to a quiet place for feeding as follows:
...
This area is largely as described in <span class="citation">K61. Elevator Trap (p. 74)</span>. However, the elevator trap triggers whenever three or more Small- and/or Medium-sized creatures are standing on its pressure plate (e.g., a **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)**, its victim, and any other creature).

> [!info]+ **Elevator Trap - Hazard 9**
> **SIMPLE MECHANICAL TRAP**
> **Stealth** DC 30 (master) to notice the seams in the floor, walls, and ceiling indicating the middle section is separate
> **Description** This hallway contains a hidden elevator compartment that traps creatures and transports them upward while filling with sleep gas.
>
> **Disable** Thievery DC 30 (master) or DC 30 Crafting (expert) to jam the mechanism preventing the portcullises from dropping, or Engineering Lore DC 28 (expert) to identify and disable the weight trigger plate.
>
> **AC** 28; **Fort** +19; **Ref** +21
> **Hardness** 18; **HP** 72; **BT** 36
> **Immunities** critical hits, object immunities, precision damage
>
> **Elevator Compartment** [reaction]
> **Trigger** When three or more Small or Medium creatures stand on the 10-foot-square section of floor in the center of the hall, or when the lever in area K31 is raised;
> **Effect** Two steel portcullises drop to seal the compartment, and the elevator begins rising. All creatures in the compartment must succeed at a DC 32 Fortitude save or fall unconscious as though affected by a [Sleep 4th rank](https://2e.aonprd.com/Spells.aspx?ID=1675) spell. At the same time, a counterweight descends on the opposite side of the shaft, dealing 4d10+26 bludgeoning damage to any creature in that space (DC 30 Reflex basic save).
>
> **Ceiling Crush** When the elevator reaches the top of the shaft at the end of its first round, any creature on top of the elevator must succeed at a DC 30 Reflex basic save or take 4d10+26 bludgeoning damage.
>
> **Secret Escape** A secret trapdoor in the ceiling of the elevator can be found with a DC 20 Perception check (trained). The trapdoor opens downward and provides access to the top of the elevator. It releases the gas.
>
> **Reset** The trap resets when the lever in area K31 is moved to the "down" position. The portcullises descend, and the elevator returns to its position in the hallway as the counterweight rises. When the elevator reaches the bottom, the portcullises retract.
...
> If a vampire spawn successfully lures one or more players into the elevator trap and knocks all of them unconscious, it attempts to drag its prey out of the elevator trap upon arriving at [[#P8a. Guest Landing]]. (They can move with half speed with a Grabbed creature during the round if they spend **Mythic** point) When it does so, it is confronted by Escher, who commands it to leave its victims and depart. Escher then brings any unconscious characters into <span class="citation">K49. Lounge (p. 70)</span>, where he drapes them across any available couches or chairs.
>
...
This area is largely as described in K65. Kitchen (p. 78). However, a hungry **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)** lurks hidden in the shadowed corners of the ceiling. A vampire spawn must succeed on Avoid Notice check or become Undetected and the initiative is rolled. He is stirring above one of the shelves.
...
This area is largely as described in K66. Butler’s Quarters (p. 78). However, a hungry **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)** lurks hidden in the shadowed corners of the ceiling. A vampire spawn must succeed on Avoid Notice check or become Undetected and the initiative is rolled. He is stirring in the southwest corner.
...
This area is largely as described in K32. Maid in Hell (p. 64). However, replace Helga with a **[Elite Animated Brooms scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=2818)**. The broom is largely as described in Broom of Animated Attack (p. 50), except it’s wearing Helga’s necklace wrapped around its wooden shaft. The broom attacks if a player attempts to remove the necklace or otherwise interfere with its cleaning.
...
This area is largely as described in <span class="citation">K35. Guardian Vermin (p. 64)</span>. However, seven **[Crawling Hand scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=2885)** emerge from the alcoves behind two **[Rat Swarm scaled to Level 6](https://2e.aonprd.com/Monsters.aspx?ID=3163)** on the first round of combat as described in <span class="citation">Crawling Claws (p. 50)</span>. Alternatively, you can replace the crawling hands with two crawling hand swarm scaled to Level 6.
One crawling hand is an [Elite Crawling Hand scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=2885) specially trained for stealth and it has +20 Stealth check to Hide in a backpack.

> [!combat]- **Balancing the Guardian Vermin**
> This combat encounter is a **Low+** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
>   - **Three Players**. Reduce the number of swarms of rats to one.
>   - **Five Players**. Make the rat swarms Elite.
>   - **Six Players**. Make the rat swarms Elite. Add one more rat swarm.
...
This area is largely as described in <span class="citation">K36. (p. 65)</span>. However, nothing happens if the players take the groom figurine from the cake, and Pidlwick’s ghost doesn’t appear if a player plays the harp. In addition, the doors leading to <span class="citation">K37. Study (p. 66)</span> and <span class="citation">K43. Bath Chamber (p. 68)</span> are locked with [Locks (Good)](https://2e.aonprd.com/Equipment.aspx?ID=2731).
The lute is [Entertainer's Lute (Major)](https://2e.aonprd.com/Equipment.aspx?ID=2267).
### Study
<span class="citation"><em>This scene takes place in Chapter 4, Area K37.</em></span>

This area is largely as described in K37. Study (p. 66). However, the doors leading to K36. Dining Hall of the Count (p. 65), K45. Hall of Heroes (p. 68), and K83. Spiral Stair (p. 85) are locked with [Locks (Good)](https://2e.aonprd.com/Equipment.aspx?ID=2731). And the fire damage is moderate 4d6 persistent fire damage instead of 1d10.
...
If present, Ireena is disturbed at the sight of the portrait and its clear resemblance to her, and voices her disbelief and discomfort at the thought that Strahd would commission a portrait of her. A player who succeeds on a DC 20 Crafting check discerns that the portrait is centuries old. If informed of this fact, Ireena’s discomfort lessens, though she becomes stressed and disturbed at the prospect of this strange woman’s resemblance to her—especially if the players suggest she might be this woman’s reincarnation.
...
#### Meeting Gertruda
Gertruda is surprised to see the players, and fearful that they’re “another one of the Devil’s tricks." Players who mention Sasha or Doru, or who succeed on a DC 20 Diplomacy check can reassure Gertruda that they’re real, and no servants of Strahd.

> [!info]+ **Gertruda’s Charm**
> Although she won’t divulge it while the charm lasts, Gertruda has been charmed by Strahd since she first arrived in the castle. It was at Strahd’s request that Gertruda asked Sasha to help her escape shortly before the players’ dinner at Ravenloft, and at Strahd’s direction that Gertruda “lost" her slipper on the stairs leading from [[#P11e. Brazier Room]]. (Strahd has instructed Gertruda to lie about both of these occasions, though a player who succeeds on a DC 22 Perception check to Sense Motive notices Gertruda stumbling over her words and briefly avoiding eye contact as she does.)
>
...
As the players first move to depart the bedchamber with Gertruda, **Anastrasya Karelova** enters the study from the door leading to the [[#Hall of Heroes]], flanked by two **[Cairn Wights scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=859)**.
...
Anastrasya is also secretly joined by two additional **[Prowler Wights scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=1916)**, which conceal themselves in the secret passage between <span class="citation">K42. King’s Bedchamber (p. 68)</span> and the western end of <span class="citation">K45. Hall of Heroes (p. 68)</span>.
...
If the players defy her, Anastrasya’s smile broadens, and the rapier and wights at her side twitch as she adds, “Really—I *must* insist." If the players attack or defy her a second time, Anastrasya directs the **[Cairn Wights scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=859)** to attack. Give them Reactive Strike reaction.
...
> - **Three Players**. Reduce the number of hidden wights to one.
> - **Five Players**. Increase the number of visible wights to three.
> - **Six Players**. Increase the number of visible and hidden wights to three.
...
<p><strong><em>Vomit Blood.</em></strong> Anastrasya spews blood in a <span class="highlight">15-foot cone</span>. Each creature in that area must make a <span class="highlight">DC 14 Reflex saving throw</span>, taking <span class="highlight">7 (2d6) bludgeoning damage and 3 (1d6) necrotic damage</span> on a failed save, or half as much damage on a successful one.</p>
<h3>Bonus Actions</h3>
<p><strong><em>Telekinetic Storm.</em></strong> Each creature within a <span class="highlight">5-foot radius</span> of Anastrasya must make a <span class="highlight">DC 14 Fortitude saving throw</span>, taking <span class="highlight">4d4 force damage</span> on a failed save, or half as much damage on a successful one.</p>
<p><strong><em>Horrific Screech.</em></strong> All creatures that can hear within a <span class="highlight">30-foot radius</span> must succeed on a <span class="highlight">DC 14 Fortitude saving throw</span> or suffer the following effects: On a failed save, a creature has disadvantage on attack rolls, ability checks, and concentration checks until the start of Anastrasya's next turn. If a creature fails the save by 5 or more, it is also frightened of Anastrasya until the start of her next turn. If a creature fails the save by 10 or more, it is also paralyzed until the end of Anastrasya's next turn.</p>
<h3>Reactions</h3>
<p>Anastrasya can take up to three reactions per round, but only one per turn. If Anastrasya would lose her reactions, she loses one reaction instead.</p>
...
> [!info]+ **Paralytic Vapor Chamber Hazard 9**
>
> **Complex Mechanical Trap**
> **Stealth** +19 (expert)
> **Description** When a trapped container is opened, a pressurized system releases paralytic gas that quickly fills the room. The gas has a faint blue-green tint and smells slightly of mint.
> **Disable** DC 30 Thievery (expert) to disarm the gas release mechanism, DC 28 Crafting (expert, alchemical crafting) to neutralize the gas reservoir, or DC 27 Athletics (trained) to force open ventilation shafts that are normally sealed.
>
> **AC** 28, **Fort** +21, **Ref** +19
> **Hardness** 18, **HP** 68 (BT 34); **Immunities** critical hits, object immunities, precision damage
>
> **Release Gas** [reaction]
> **Trigger** A creature opens the trapped container without first disabling the mechanism; **Effect** The container's locking mechanism engages, ventilation shafts seal, and the paralytic gas is released into the room. The trap rolls initiative.
>
> **Routine** (1 action) The trap pumps more paralytic gas into the room each round on its initiative. Any breathing creature in the room must succeed at a DC 28 Fortitude save or be affected by the Paralytic Vapor. A creature can hold its breath before the trap's first action, but this only delays exposure until they must breathe again. The trap functions for 2 minutes before its gas supply is depleted.
>
> **Paralytic Vapor** (inhaled, poison, virulent) **Saving Throw** DC 28 Fortitude; **Effect** A creature that fails its saving throw is paralyzed for 4 hours. A paralyzed creature can attempt a new saving throw every 10 minutes. The first time a creature succeeds on this repeated saving throw, it becomes slowed 2 rather than paralyzed. The second time a creature succeeds on a repeated saving throw, all effects of the vapor end for that creature.
>
> **Reset** The trap must be manually reset and the gas reservoir refilled, which takes 1 hour and requires alchemical crafting supplies worth 50 gp.
...
If any players knock on the door or otherwise indicate their presence, the **[Phade (Invisible Stalker) scaled to Level 10](https://2e.aonprd.com/Monsters.aspx?ID=2975)** flees and returns to [P7d. Treasury](https://publish.obsidian.md/strahdreloaded-pf2e/Act+III+-+The+Broken+Land/Arc+P+-+Ravenloft+Heist#P7d. Treasury). Otherwise, if the players fail to indicate their presence, the invisible stalker passes through a crack in the wall and enters the chamber. Read:
...
The sound of the bell attracts two **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)**, who pass from K53. Rooftop (p. 71) into K20. Heart of Sorrow (p. 59), then descend to K45. Hall of Heroes (p. 68) before entering the false treasury via the secret door in K37. Study (p. 66). The vampires attack the players on sight.
...
### Entering the Tower
This area is largely as described in <span class="citation">K41. Treasury (p. 67)</span>. However, the command word to the *[Instant Fortress](https://2e.aonprd.com/Equipment.aspx?ID=366).* is the same phrase as for the *Tome of Strahd*: “I come in Dostron’s memory."
...
The contents of the treasury are largely as described in K41. Treasury (p. 67).
The fortress is [Instant Fortress](https://2e.aonprd.com/Equipment.aspx?ID=366).
Coins and gems are in the same amount. The Silver Dragon shield is [Shining Shield](https://2e.aonprd.com/Equipment.aspx?ID=1574).

However, replace the _alchemy jug_, _helm of brilliance_, and _rod of the pact keeper, +1_ with:

- [Magic Wand (4th-rank Spell)](https://2e.aonprd.com/Equipment.aspx?ID=3050) of [Moonlight Ray](https://2e.aonprd.com/Spells.aspx?ID=2358);
- [Charlatan's Cape](https://2e.aonprd.com/Equipment.aspx?ID=3063);
- A stuff that will be useful to your players (i.e. [Staff of Protection (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=3045));
- [Spiritsight Crossbow](https://2e.aonprd.com/Equipment.aspx?ID=3285) hanging from a hook on the wall;
- An _amber shard_ of Great Taar Haak, the Five-Headed Destroyer. (See the [Amber Shards](https://publish.obsidian.md/strahdreloaded-pf2e/Appendices/Amber+Shards) appendix for more information about amber shards.).

In addition, replace the four _potions of greater healing_ with [Elixir of Life (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=3308).

An **[Phade (Invisible Stalker) scaled to Level 10](https://2e.aonprd.com/Monsters.aspx?ID=2975)** bound by Strahd to protect the treasury’s contents lurks in the upper floor of the tower. The invisible stalker has the following changes to its statistics:

- It has the **_air form_** feature of an **air elemental** (it can move through spaces if it's at least 1 inch narrow).
...
This area is largely as described in <span class="citation">K47. Portrait of Strahd (p. 68)</span>.
For the portrait, use **[Arcane Living Rune scaled to Level 9](https://2e.aonprd.com/Monsters.aspx?ID=1222)** but give it **[Ghost Mage](https://2e.aonprd.com/Monsters.aspx?ID=3008)**'s spells and Counterspell reaction. It is also always Immobilized and Off-guard.
Rug is - **[Cloaker scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=82)**  with a Construct trait;

> [!combat]- **Balancing the Guest Landing**
> This combat encounter is a **Moderate** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
> * **Three Players**. Apply Weak template to both.
> * **Five Players**. Apply Elite template to the rug.
> * **Six Players**. Apply Elite template to both.
...
The cat is the familiar of a **Barovian witch** in [[#P9. Coven’s Quarters]], and disappears up the stairs on initiative count 20 of the following round. Unless the players kill, capture, or otherwise stop it, it goes to warn its mistress in [[#P9c. Cauldron Room]] of the players’ presence. (If killed, the cat vanishes as it was a *familiar*.)

Shortly after combat ends, the door to <span class="citation">K49. Lounge (p. 70)</span> cracks open, and a pale, anxious-looking face peers out. (A player who succeeds on  DC 24 Perception check recognizes the face as Escher’s.) Upon noticing the players, Escher then immediately slams the door shut again.
## P8b. Guest Suite
...
***Threatening Escher.*** Players who threaten Escher and succeed on a DC 26 Intimidation check can convince him to provide the information in **What Escher Knows** below. Otherwise, Escher cowers and pleads for mercy while insisting he cannot betray “Count von Zarovich."
...
As the conversation unfolds, if Ireena is present, a player who succeeds on DC 24 Perception check to Sense Motive notices that Escher appears to be studiously refusing to meet her gaze. A successful subsequent DC 24 Perception check to Sense Motive reveals that Escher appears to flinch and quickly look away whenever he notices Ireena’s eyes meet his own.

Players who invoke Escher’s former relationship to the village of Barovia and succeed on a DC 26 Diplomacy check can convince him to share the information contained in **What Escher Knows** below. A player makes the check with advantage if they blame Escher aloud for Strahd’s awakening and Strahd’s subsequent hunt for Ireena, Gertruda’s imprisonment, or Doru’s vampirism, and succeeds automatically if Doru is present. On a failure, Escher politely declines to assist the players, insisting that he cannot betray “Count von Zarovich’s secrets" on pain of death.
...
>
> As they leave, a player who succeeds on DC 24 Perception check to Sense Motive notices that Escher’s shoulders are trembling with silent sobs.
# P9. Coven’s Quarters
...
>
> Barovian Witch's familiar is black cat with a darkvision, shared senses, darkeater and scent as an imprecise sense to a range of 30 feet.
## P9b. Element Room
<span class="citation"><em>This scene takes place in Chapter 4, Area K55.</em></span>

This area is largely as described in <span class="citation">K55. Element Room (p. 72)</span>. However, a **[Zombie Brute scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=3251)** stands silently at the center of the room. (The zombie doesn’t attack except in self-defense, or except as directed by the coven.) Add the following to the end of this area’s description:
...
> If the players failed to prevent the **black cat** familiar in [[#P8a. Guest Landing]] from alerting its mistress, the coven has used the contents of the cauldron in [[#P9c. Cauldron Room]] to transform the zombie into a **[Mythic Elite Zombie Brutes scaled to Level 5 with virulent miasma - Medium](https://2e.aonprd.com/Monsters.aspx?ID=3251)** and add a [Ferocity](https://2e.aonprd.com/MonsterAbilities.aspx?ID=63) reaction to its statblock. Add the following to this area’s description:
>
> <hr>
...
> <hr>
>
> The seven witches in [[#P9c. Cauldron Room]] are immune to poison because of the ritual. They also cast _invisibility_ spells on themselves, and spread themselves around the corners of the room. The witches attack as soon as the players fully enter the room. Roll Stealth for their initiative.

> [!info]+ **Virulent Miasma**
> Giant zombie exhales a deadly poisonous red mist cloud in a 30-foot emanation. The cloud deals 6d6 poison damage to all creatures in the area, which must attempt a DC 22(24 if Elite) Basic Fortitude. Giant zombie can't use Virulent Miasma again for 1d4 rounds.
> On a failure the creature is also exposed to Zombie Rot.

A player who searches the room and succeeds on a DC 24 Perception to Search or DC 22 Crafting check to Investigate finds a *[Fire Breath Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2941)* hidden amongst the bottles and jars.
...
Two of the brown brooms are _brooms of inferior flying_, and the other four brown brooms are **[Animated Brooms scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=2818)** . The black broom is a _broom of flying_. If a creature other than one of the witches in [[#P9c. Cauldron Room]] attempts to take any of the brooms, the **brooms of animated attack** animate and attack.
...
> A *broom of flying* cannot fly unless its command word is spoken. A creature can learn a magic item’s command word by succeeded on Identify Magic check with DC 26 Arcana or Occultism.

> [!item]+ **Flying Brooms**
> ***Brooms of Inferior Flying.*** A *broom of inferior flying* can be used only for flying as a [Flying Broomstick](https://2e.aonprd.com/Equipment.aspx?ID=3023) for 10 minutes if activated with two actions (concentrate, manipulate) using a command word. It can be done only once per day.
>
> ***Broom of Flying.*** The coven’s single *[Flying Broomstick](https://2e.aonprd.com/Equipment.aspx?ID=3023)* is enchanted with a mild form of sentience, and is loyal only to the witches of the coven. If any other creature attempts to ride it, the broom begins bucking and rolling uncontrollably once it has risen at least twenty feet above the ground. At the start of each of the rider’s turns, it must succeed on a DC 30 Reflex save as per [Buck](https://2e.aonprd.com/MonsterAbilities.aspx?ID=54) reaction or plummet to the ground. Once it has removed its rider, the broom then attempts to fly back to its rack in Castle Ravenloft.
>
> The broom becomes permanently docile if its rider threatens to destroy or harm it in Common, Infernal, or Abyssal and succeeds on a DC 28 Intimidation check. The broom also ceases attempting to throw a particular rider if that rider successfully makes five consecutive Reflex saving throws to avoid being thrown, although the broom then sullenly reduces its flying speed to 10 feet for the duration of the flight.
## P9c. Cauldron Room
...
The spellbook is guarded with [Bandit's Doom](https://2e.aonprd.com/Spells.aspx?ID=866) (DC 28).

> [!lore]+ **The Cauldron**
> The potion in the cauldron, when imbibed by a **[Zombie Brute scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=3251)**, transforms it into a **[Mythic Elite Zombie Brutes scaled to Level 5 with virulent miasma - Medium](https://2e.aonprd.com/Monsters.aspx?ID=3251)**. Due to the enchantments layered into the potion by the witches, a **[Mythic Elite Zombie Brutes scaled to Level 5 with virulent miasma - Medium](https://2e.aonprd.com/Monsters.aspx?ID=3251)** created in this way is loyal first to Strahd, second to Rahadin, third to Strahd’s consorts, and last to the witches who created it. Unless ordered otherwise, the plague spreader attacks any non-undead on sight.

In addition, replace the seven **Barovian witches** with two **Barovian hexwitches** wearing bone earrings, two **Barovian bogwitches** with brown paint smeared around their eyes, and three **Barovian stormwitches** wearing black leather gloves (see below). Each witch carries a _[Healing Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2943)_, a _[Sight-Theft Grit poison masked like Healing Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2013)_.

Use [Mythic Weak Demonologist](https://2e.aonprd.com/NPCs.aspx?ID=3540) stat block which has only 3rd Rank spells and uses Occult. And give it [Starless Shadow](https://2e.aonprd.com/Patrons.aspx?ID=17) spells - [_shroud of night_](https://2e.aonprd.com/Spells.aspx?ID=1891) and _[needle of vengeance](https://2e.aonprd.com/Spells.aspx?ID=1881)_. Add a **Forge Pact** action from  [Coven Aspirant](https://2e.aonprd.com/NPCs.aspx?ID=3535).
Remove **Demon Summoning**.
Make it Mythic with Remove Condition and Fortitude and Will Mythic Resilience.

> [!combat]- **Balancing the Witches**
> This combat encounter is a **Severe** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
>
...
> * **Five Players**. Remove Weak from the next witches: Diavola, one hexwitch and one bogwitch.
> * **Six Players**. Remove Weak from all witches.
...
One of the Barovian stormwitches is Diavola, the leader of the coven. Diavola is an Elite Stormwitch, who wears pewter earrings shaped like lightning bolts, has an additional 2nd-level and 3rd-level spell slots. In addition, rather than a [Healing Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2943), Diavola carries a *[Elixir of Life (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=3308)*. On her first turn in combat, Diavola cries: "We shall defeat you as Mother Lysaga taught us—for the glory of Brother Strahd!"

> [!info]+ **Hexwitches, Bogwitches & Stormwitches**
>
> A **Barovian hexwitch** is a **Barovian witch** with the following spells prepared:
>
> - Cantrips (at will): Forbidding Ward, Telekinetic Hand, Prestidigitation, Void Warp, Shield
> - 1st level (4 slots): Phantom Pain, Befuddle, Ill Omen, Bane
> - 2nd level (3 slots): Darkness, Invisibility, Paranoia
> - 3rd level (3 slots): Blindness, Paralyze, Vampiric Feast
>   In combat, a Barovian hexwitch prefers to begin by casting _Blindness_, followed by _Phantom Pain_. If cornered, a hexwitch prefers to defend herself by casting _Invisibility_ or _Paralyze._
>
> A **Barovian bogwitch** is a **Barovian witch** with the following spells prepared:
>
> - Cantrips (at will): Daze, Guidance, Telekinetic Hand, Prestidigitation, Shield
> - 1st level (4 slots): Grim Tendrils, Force Barrage, Penumbral Shroud, Fear
> - 2nd level (3 slots): Vomit Swarm, Invisibility, Blood Vendetta
> - 3rd level (3 slots): Wall Of Shadow, Slow, Agonizing Despair
>   In combat, a Barovian bogwitch prefers to begin by casting _Slow_ and _Wall Of Shadow_, followed by _Grim Tendrils_ if she can hit at least three targets, and _Force Barrage_ otherwise. Use other
>
> A **Barovian stormwitch** is a **Barovian witch** with the following spells prepared:
>
> - Cantrips (at will): Electric Arc, Ray of Frost, Phase Bolt
> - 1st level (4 slots): Lose the Path, Eat Fire, Soothe, Fear
> - 2nd level (3 slots): Loose Time's Arrow Noise Blast, Resist Energy, Invisibility
> - 3rd level (3 slots): Haste, Levitate, Shadow Projectile
>   In combat, a Barovian stormwitch prefers to begin by casting _Noise Blast_, followed by _Haunting Hymn_. If escape is needed, she casts _Haste_ on herself followed by _Levitate_.
# P10. Garrison
...
This area is largely as described in <span class="citation">K67. Hall of Bones (p. 78)</span>. Argynvost’s skull is 10 bulk. However, if Argynvost’s skull is removed from its mount, a **skeleton** crawls from each of the four mounds of bones at the corners of the room. The skeletons attack living creatures on sight.

For the next 1 minute, an additional **skeleton** crawls from each non-destroyed bone mound at initiative count 0 of each round. Each bone mound has AC 25, 40 hit points, Hardness 8, object immunities, Weakness 5 bludgeoning.

Instead of just skeletons, feel free to use any or all of the following:
- [Necrophidius scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=738)
- [Wolf Skeleton scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=1899)
- [Skeleton Guard scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=3193)
- [Skeletal Champion scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=3194)
- [Harpy Skeleton](https://2e.aonprd.com/Monsters.aspx?ID=1298)
- [Skeletal Mage](https://2e.aonprd.com/Monsters.aspx?ID=1901)
...
All alcoves are occupied by zombies. Together they form a **[Shambler Troop scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=1376)** except the back-left alcove. In each of the four central alcoves, additionally there are **[Mythic Elite Zombie Brutes scaled to Level 5 with virulent miasma - Medium](https://2e.aonprd.com/Monsters.aspx?ID=3251)**.

The zombies and zombie plague spreaders don’t move or respond to stimuli, and attack only in self-defense.

The back-left alcove conceals a **[Crawling Plague Zombie](https://2e.aonprd.com/Monsters.aspx?ID=3250)** that is missing both of its legs, so that only its head, torso, and arms remain. When a living creature attempts to retrieve the wooden spoon beside its alcove, the crawling zombie uses its arms to fling itself into the air and attack.

Treat the crawling zombie as a **[Plague Zombie](https://2e.aonprd.com/Monsters.aspx?ID=3250)** with the following modifications:

* It has 40 hit points and it can only **Crawl**.
* As a reaction, on a successful hit with its ***slam***, the crawling zombie can wrap one of its arms around the target to cling to it. While clinging to a target in this way, the crawling zombie has -4 Circumstance penalty on attack rolls and moves with the target.
...
This area is largely as described in <span class="citation">K71. Kingsmen Quarters (p. 79)</span>. However, the sack beneath the loose flagstone in the southeast alcove also contains a *[Fearless Sash](https://2e.aonprd.com/Equipment.aspx?ID=2311)*.
...
This area is as described in <span class="citation">K11. South Archers’ Post (p. 57)</span> and <span class="citation">K12. Turret Post (p. 57)</span>. However, a single **[Elite Shadow](https://2e.aonprd.com/Monsters.aspx?ID=3186)** dwells here, as described in <span class="citation">Shadows (p. 51)</span>.

This **[Elite Shadow](https://2e.aonprd.com/Monsters.aspx?ID=3186)**, which understands Common but can’t speak it, is the remnant of a spirit that died in the castle long ago. If permitted to do so, it shyly attempts to follow the players throughout Castle Ravenloft, though it hides itself among nearby furniture or architecture if confronted or attacked. If this occurs, a player can coax it back from hiding with a successful DC 22 Diplomacy check.

The shadow is lonely and longs for the company of others—including, particularly, its friend, another **[Elite Shadow](https://2e.aonprd.com/Monsters.aspx?ID=3186)** lost elsewhere in the castle. Though it won’t fight on the players’ behalf, players who ask and succeed on a DC 26 Diplomacy check can convince the shadow to use its ***Incorporeal*** feature to investigate adjacent rooms for danger while using its ***Slink in Shadows*** feature to remain concealed. The check succeeds automatically if the players agree to help the shadow reunite with its friend.
...
> The Heart of Sorrow is largely as described in  <span class="citation">K20. Heart of Sorrow (p. 59)</span>. However, it is immune to all damage, and no **vampire spawn** attack characters that attack it. In addition, rather than shaking the tower on initiative count 10 each round, the Heart shakes the tower each time the players attempt to ascend an additional story toward the Heart. DC 30 Reflex saving throw.
>
> A character who fails the Reflex saving throw against the shaking tower and falls as a result can catch themselves on the edge of the stairs by succeeding on a DC 30 Reflex saving throw or Acrobatics check to Grab an Edge.
>
> For Animated Halberts, use [Animated Armor scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=2819) stat block but give it a Fly speed equal 50.
...
If the players are kind toward Pidlwick II and succeed on a DC 24 Diplomacy check, they can convince it to depart the castle with them to meet the toymaker Gadof Blinsky.
...
This area is largely as described in <span class="citation">K13. Turrets Post Access Hall (p. 57)</span>. However, **swarm of crawling hands scaled to level 6** cling to the ceiling above the secret door leading to <span class="citation">K25. Audience Hall (p. 61)</span>, and drop down to attack any creature that passes beneath them. The claws otherwise behave as described in <span class="citation">Crawling Claws (p. 50)</span>. One crawling hand is an [Elite Crawling Hand scaled to Level 4](https://2e.aonprd.com/Monsters.aspx?ID=2885) specially trained for stealth and it has +15 Stealth check to Hide in a backpack.
...
On the bridge, a character is subjected to [Uneven Ground](https://2e.aonprd.com/Rules.aspx?ID=2370) but should use Athletics and Fortitude to overcome the Balance. DC is 22.
A Fly action requires [Maneuver in Flight](https://2e.aonprd.com/Actions.aspx?ID=2371) action with the same DC.
...
A player who inspects the bed notices dark bloodstains coloring the bed and nearby floor. A DC 26 Medicine check reveals that the bloodstains can’t be older than a few months old.

A player who succeeds on a DC 24 Perception also notices a large, black, bloodstained feather fallen between the bed’s wooden frame and straw-stuffed mattress. A successful DC 24 Nature check identifies the feather as a raven’s, though curiously oversized, such that the raven it belonged to would have had to have been the size of a human.
...
I suggest making it a [Huge Vampire Bat Swarm scaled to level 10](https://2e.aonprd.com/Monsters.aspx?ID=2848) - it'll make it easier to manage and still fun to fight.

> [!combat]- **Balancing the North Tower Rooftop**
> This combat encounter is a **Moderate** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
> * **Three Players**. Apply Weak template to the swarm.
> * **Five Players**. Apply Elite template to the swarm.
> * **Six Players**. Add another Level 10 swarm.
# P11. Dungeons
## P11a. Dungeon Hall
...
This area is largely as described in <span class="citation">K74. North Dungeon (p. 80)</span>. The rusty iron door can be opened with a DC 20 Athletics check to Force Open.
However, modify the half-elf corpse in <span class="citation">K74c. Rotting Corpse (p. 80)</span> to be a human corpse instead.
- A Gray Ooze is an **[Elite Gray Ooze](https://2e.aonprd.com/Monsters.aspx?ID=753)**.
- And a potion of heroism can be replaced with some nice potion potion of 7-9 level. For example, a [Potion of Quickness](https://2e.aonprd.com/Equipment.aspx?ID=2950) or even a [Octopus Potion (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=2630).

In addition, modify the description of <span class="citation">K74h. Lost Sword (p. 81)</span> to refer to a glowing mace, rather than a glowing blade. The mace has [Crushing](https://2e.aonprd.com/Equipment.aspx?ID=1298) property, but is not sentient, and allows its wielder to cast *[Cloak Of Light](https://2e.aonprd.com/Spells.aspx?ID=2346)* once per day.
...
This area is largely as described in <span class="citation">K75. South Dungeon (p. 81)</span>. The rusty iron door can be opened with a DC 20 Athletics check to Force Open.
...
> While worn by a lycanthrope, the lycanthrope can't regenerate. In addition, the interior of a *silverthorn* collar extrudes tiny silver thorns each time the lycanthrope attempts to transform, dealing 1 piercing damage and preventing the transformation.
>
...
This area is largely as described in <span class="citation">K76. Torture Chamber (p. 82)</span> and <span class="citation">K77. Observation Balcony (p. 82)</span>. However, remove the reference to the “last victims" of the torture devices in the water. In addition, replace the six **Strahd zombies** with two **[Sulfur Zombie](https://2e.aonprd.com/Monsters.aspx?ID=1377)** and two **[Withered](https://2e.aonprd.com/Monsters.aspx?ID=1922)**, and add a three-foot amphora and a box of alchemist consumables. The amphora is filled with several gallons of flammable oil.
You can put some fun and useful oils and elixirs there (three or four consumable items).
For example:
- [Oil of Swiftness](https://2e.aonprd.com/Equipment.aspx?ID=2075);
- [Ghost Oil](https://2e.aonprd.com/Equipment.aspx?ID=1571);
- [Elixir of Gender Transformation (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=3307);
- [Winterstep Elixir (Lesser)](https://2e.aonprd.com/Equipment.aspx?ID=1518);
- Some bombs or poisons.

> [!info]+ **Climbing the Balcony**
> A successful DC 20 Athletics check to Climb is required to climb the edge of the observation balcony.

If the players failed to placate Volenta during [[Arc O - Dinner with the Devil#Volenta’s Toy|Arc O - Dinner with the Devil]], the corpse of Anton Konstantinovich has been turned into an additional **[Withered](https://2e.aonprd.com/Monsters.aspx?ID=1922)** and is seated in the right-side throne of <span class="citation">K77. Observation Balcony (p. 82)</span>. If combat breaks out, or if any non-undead creatures approach within 5 feet of its throne, this **[Withered](https://2e.aonprd.com/Monsters.aspx?ID=1922)** attacks and pursues the nearest living creatures within the area.
...
> >
> > At the end of each of an imprisoned creature’s turns, it must succeed on a DC 22 Reflex basic saving throw, taking 13 (2d8+4) piercing damage. The DC increases by 1 every 10 minutes.
> >
> > A creature can open the iron maiden from the inside or outside by succeeding on three successful DC 20 Thievery checks to Pick a Lock or a DC 30 Athletics check to Force Open. A creature imprisoned within the iron maiden has disadvantage on any check made to open it, and automatically takes 45 (13d6) piercing damage each time it attempts to do so.
>
> > [!info]- **The Rack.**
...
> >
> > Each additional time the winch is used to retract the chains, an imprisoned character must succeed on a DC 22 Fortitude basic saving throw, taking bludgeoning damage. The damage begins at 4 (1d8) and increases by an additional 4 (1d8) each time the chains are retracted.
> >
> > The manacles are largely as described in [Manacles (Average)](https://2e.aonprd.com/Equipment.aspx?ID=2733), and the chains and the manacles have Hardness 4 and 18 HP (BT 9 HP). However, because the manacles and chains have rusted with age, the DC to Force Open is DC 25 Athletics check only.
>
> > [!info]- **The Brazen Bull**
> > This device is a bronze bull with a large, hollow, locked compartment in its stomach. A character teleported to this device from [[#P11a. Dungeon Hall]] finds themselves tucked into the bull’s stomach compartment, their body contorted into fetal position. While imprisoned in this way, a character is Slowed 1 and Grabbed.
> >
> > The bull’s stomach also contains a **[Shredskin scaled to Level 5 plus it has a Reactive Strike](https://2e.aonprd.com/Monsters.aspx?ID=1897)** , which attacks any living creatures on sight.
> >
> > > A creature can open the bull’s stomach compartment by succeeding on three successful DC 25 Thievery checks to Pick a Lock or a DC 30 Athletics check to Force Open. A creature imprisoned within the bull has -2 Circumstance penalty on any check made to open it.
>
> > [!info]- **The Breaking Wheel**
> > This device is a large metal wheel with four rusted iron manacles attached to its circumference. A character teleported to this device from [[#P11a. Dungeon Hall]] finds themselves manacled to the device, their arms and legs spread and shackled against its metal frame. While imprisoned in this way, a character is [Restrained](https://2e.aonprd.com/Conditions.aspx?ID=90) plus can't use any action that involves movement (like casting a spell). It has an additional -2 Item Penalty to its AC.
> >
> > The manacles are largely as described in [Manacles (Average)](https://2e.aonprd.com/Equipment.aspx?ID=2733), and the chains and the manacles have Hardness 4 and 18 HP (BT 9 HP). However, because the manacles have rusted with age, the DC to Force Open is DC 25 Athletics check only.
>
...
> >
> > A character teleported into the scavenger’s daughter is forced to hold their breath as described in [Drowning and Suffocating](https://2e.aonprd.com/Rules.aspx?ID=2439) unless they can breathe underwater.
> >
> > The manacles are largely as described in [Manacles (Average)](https://2e.aonprd.com/Equipment.aspx?ID=2733), and the chains and the manacles have Hardness 4 and 18 HP (BT 9 HP). However, because the manacles have rusted with age, the DC to Force Open is DC 25 Athletics check only. An imprisoned character can’t remove their head from the frame until they have escaped both manacles.
...
> Due to the phase mechanic, this combat encounter is a series of two consecutive **Moderate+** combat encounters against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
>
> * **Three Players**. Reduce the number of zombies to one each.
> * **Five Players**. Increase the number of sulfur zombies to three.
> * **Six Players**. Increase the number of zombies to three each.
...
On initiative count 20 of each subsequent round, the oil spreads an additional five feet in every direction. If fire damage is dealt to any creature in a section covered with oil, or if any section of oil is otherwise ignited, the entire oil slick ignites, continuing to burn for the next 2 rounds. A creature that starts its turn in the burning oil takes 2d6 persistent fire damage.
...
<p><strong><em>Thunderstone (2/day).</em></strong> Volenta hurls a crystalline shard at a creature, object, or surface within 30 feet. The shard shatters on impact with a blast of concussive energy. Each creature within 10 feet of the point of impact must succeed on a <span class="highlight">DC 14 Fortitude saving throw</span> or be knocked prone and pushed 10 feet away from that point. A creature that fails the save is also deafened until the start of Volenta's next turn.</p>
<p><strong><em>Froststar (3/day).</em></strong> Volenta throws a crystalline shard at a point she can see within 30 feet. The shard explodes on impact, covering the area with thick, icy frost. Each creature within 5 feet of the point of impact must make a <span class="highlight">DC 14 Reflex saving throw</span>. On a failed save, a creature takes 2d6 cold damage and is restrained by ice until the start of Volenta's next turn. On a successful save, a creature takes half the damage and isn't restrained. A restrained creature can use its action to make a <span class="highlight">DC 14 Strength check</span> to break free. A 5-foot-square section of ice has AC 10, 15 hit points, vulnerability to bludgeoning and fire damage, and immunity to cold, poison, and psychic damage.</p>
<p><strong><em>Alchemist's Firebomb (1/day).</em></strong> Volenta hurls a flask of concentrated alchemist's fire at a point within 30 feet. The vial shatters on impact and detonates in a 10-foot radius. Any creature in that area must succeed on a <span class="highlight">DC 14 Reflex saving throw</span> or take 2d6 fire damage and be set ablaze. A creature set ablaze in this way takes 1d4 fire damage at the start of each of its turns, and can make an additional DC 14 Reflex saving throw at the end of each of its turns to extinguish the flames.</p>
<h3>Bonus Actions</h3>
...
A successful DC 26 Nature check identifies “monkshood" as a colloquial name for wolfsbane.
...
> * <span class="citation">K20. Heart of Sorrow (p. 59)</span> otherwise.
>
> If Rahadin confronts the players in <span class="citation">K78. Brazier Room (p. 82)</span>, he removes the seven stones set into the brazier's rim and places them into a small leather pouch before they enter the room. He then ties the leather pouch to his belt. If the players notice the stones' disappearance before noticing Rahadin's ***screams of the dead***, he emerges from his hiding place behind one of the iron golems and asks, "Looking for these?" A player can attempt to sever the pouch from Rahadin's belt by making an attack against Rahadin's AC +5. On a hit, the pouch is severed if the string tying it to Rahadin's belt takes at least 1 point of piercing, slashing, fire, acid, necrotic, radiant, or force damage. Rahadin also automatically drops the pouch if he uses the *amulet of Ravenloft* to pass through a wall, ceiling, or floor of the castle.
>
> See [[#South Crypts, Third Row]] for more information about Rahadin's statistics and appearance.
## P11f. Western Stair
<span class="citation"><em>This scene takes place in Chapter 4, Areas K79.</em></span>

This area is largely as described in <span class="citation">K79. Western Stair (p. 84)</span>. However, remove the *glyph of warding*. Instead, a curious, yet fearful **[Elite Shadow](https://2e.aonprd.com/Monsters.aspx?ID=3186)** lurks here.
...
If the players enter the staircase via the secret door in <span class="citation">K72. Chamberlain’s Office (p. 79)</span>, the shadow flees downward, concealing itself behind the western **[Iron Warden scaled down to Level 11](https://2e.aonprd.com/Monsters.aspx?ID=3068)** in <span class="citation">K78. Brazier Room (p. 82)</span>. While the players remain in <span class="citation">K78. Brazier Room (p. 82)</span>, the shadow amuses itself by pretending to be a player’s shadow. A player who succeeds on DC 24 Perception check notices that the chosen player has an extra shadow.
...
---
### Foggy Marble Slide - Hazard 10
This hidden trapdoor lurks beneath lingering fog, waiting to send victims sliding into the depths below.

**Complexity** Simple **Stealth** DC 34 (master)
**Description** A concealed trapdoor lies beneath a thick layer of lingering fog in a tunnel. The trapdoor leads to a polished marble chute that deposits victims into a flooded cell.

**AC** 33, **Fort** +24, **Ref** +21 **Trapdoor Hardness** 14, **Trapdoor HP** 56 (BT 28);
**Immunities** critical hits, object immunities, precision damage

**Disable** DC 36 Thievery (master) to wedge or jam the trapdoor mechanism, or DC 36 Athletics (expert) to force an iron spike into the edges, preventing it from opening.

**Sudden Drop** ↻ (mechanical) **Trigger** A Small or Medium creature places its weight on the trapdoor;
**Effect** The trapdoor swings open and the triggering creature can try to Grab an Edge to avoid falling. The DC to Climb the walls or Grab an Edge is 33.
If the creature fails to Grab an Edge, it falls through the trapdoor and slides down the polished marble chute, traveling 60 feet before being deposited into a flooded cell. The creature is moved to the cell and is prone upon arrival.

**Reset** The trapdoor automatically resets after 1 minute, using concealed counterweights to swing back into place. The fog gradually refills the area, requiring 10 minutes to fully conceal the trapdoor again.
...
The stone slab can be opened/closed with a successful DC 26 Athletics check.
The teleport traps can be suppresses with a [_dispel magic_](https://2e.aonprd.com/Spells.aspx?ID=78) (5th level; [counteract](https://2e.aonprd.com/Rules.aspx?ID=371) DC 28) spell or similar magic.
...
For _Prince Ariel du Plumette_, use [Ghost Commoner to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3007) stat block but give him the next feature:

- **Ariel the Heavy Possession** [three-actions] ([incapacitation](https://2e.aonprd.com/Traits.aspx?ID=93), [mental](https://2e.aonprd.com/Traits.aspx?ID=106), [necromancy](https://2e.aonprd.com/Traits.aspx?ID=117), [occult](https://2e.aonprd.com/Traits.aspx?ID=120), [possession](https://2e.aonprd.com/Traits.aspx?ID=129)) Ariel the Heavy attempts to possess an adjacent corporeal creature. This has the same effect as the [_possession_](https://2e.aonprd.com/Spells.aspx?ID=225) spell (DC 26 Will), except the duration is 24 hours and, since Ariel the Heavy doesn't have a physical body, they're unaffected by that restriction of the spell. If the target has critically failed its save and become fully possessed by Ariel the Heavy before, it gets a save result one degree of success worse than it rolled.
...
This row of crypts is largely as described in <span class="citation">Crypt 7 (p. 87)</span>, <span class="citation">Crypt 8 (p. 87)</span>, <span class="citation">Crypt 9 (p. 87)</span>, <span class="citation">Crypt 10 (p. 87)</span>, and <span class="citation">Crypt 11 (p. 87)</span>. However, a player who picks up Tasha Petrovna’s holy symbol in <span class="citation">Crypt 11 (p. 87)</span> does not hear a message. Also, I suggest making the holy symbol - [Shining Symbol (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=3109).

Crypt 7's **[Gargoyles are scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=3001)** .

In addition, a human corpse lies sprawled across the floor immediately south of <span class="citation">Crypt 2 (p. 87)</span>. If approached, the corpse rises as a **[Withered](https://2e.aonprd.com/Monsters.aspx?ID=1922)** and attacks.

Players who fight the **[Withered](https://2e.aonprd.com/Monsters.aspx?ID=1922)** south of Crypt 2, or who attempt to avoid the zombie by descending to [[#North Crypts, Third Row]] via any other intersection, draw the attention of a **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)** lurking amidst the catacombs. Read:
...
Roll for an Avoid Notice for the spawn from time to time. If it fails, it becomes Undetected and the players hear distant rustling or catch glimpses of the vampire’s shadow out of the corner of their eye, indicating its current location. Roll initiative if they decide to hunt it down. The **[Mythic Vampire Servitors scaled to Level 8](https://2e.aonprd.com/Monsters.aspx?ID=3224)** rolls Stealth for the initiative.
...
---
### Crypt 12's Cursed Helm
**Complexity** Simple

**Stealth** DC 28 (master)

**Description** A steel helm with three visages—one sad, one happy, one angry—rests atop a weight-sensitive marble slab. The 1 Bulk (10-pound) helm must be replaced with equal weight, or poisonous gas erupts from concealed vents.

**Disable** DC 28 Thievery (master) to jam the weight mechanism within the marble base, or DC 28 Athletics (master) to precisely swap the helm with an equal 1 Bulk (10-pound) weight without triggering the trap.

**Poison Gas Release** ↻ (mechanical) **Trigger** The helm is removed from the slab without immediately replacing its 10-pound weight;
**Effect** Noxious gas erupts from tiny holes in the marble base, filling the crypt. All creatures within 10 feet must attempt a DC 26 Fortitude save.
**Critical Success** The creature is unaffected
**Success** The creature takes 2d10+11 poison damage.
**Failure** The creature takes 4d10+22 poison damage and is Sickened 1
**Critical Failure** The creature takes 6d10+33 poison damage and is Sickened 2.

**Reset** The trap is a one-time hazard and does not reset once its pressurized gas canister is emptied.

---

***Crypt 13.*** You can put [Mindlance](https://2e.aonprd.com/Equipment.aspx?ID=1891) or [Solar Shellflower](https://2e.aonprd.com/Equipment.aspx?ID=1892) (if you want to be a bit cruel) instead of musket. The horn has a [Black Powder (Keg)](https://2e.aonprd.com/Equipment.aspx?ID=1190) mechanics. And the glider is [Glider](https://2e.aonprd.com/Vehicles.aspx?ID=58).

***Crypt 14.*** Climb DC is 20. The wights are [Elite Cairn Wight](https://2e.aonprd.com/Monsters.aspx?ID=859) and for the skeletons I suggest using [Skeleton Infantry](https://2e.aonprd.com/Monsters.aspx?ID=1300) but it should get 2d6+12 Hit Points each time a wight dies. A coffin's lid can be lifted with a DC 19 Athletics check. The area is a Difficult Terrain.

***Crypt 15.*** Speaking the name “Khazan" inside Crypt 15 does not cause a *staff of power* to materialize. Instead, the back wall of the crypt is engraved with eight arcane runes and the inscription: “The one who marks my seal with their mastery may prove themselves worthy to inherit my legacy."  A player with proficiency in Arcana, or who makes a successful DC 19 Arcana check, identifies the runes as the symbols of the eight schools of magic. The order of the symbols, moving clockwise around the engraving, is: illusion, abjuration, necromancy, conjuration, divination, enchantment, transmutation, evocation.
...
If a spell of the wrong school is cast into a rune, or if the runes are activated in the wrong order, the eight runes erupt with magical energy. Each creature within the crypt must make a DC 28 Reflex basic saving throw. A creature takes 5d8 sonic damage on a failed saving throw. Once the runes release this energy, they become inert for the next twenty-four hours.

If the proper sequence is activated, Khazan's staff (see below) materializes above the marble slab and hovers in place, crackling with magical power. The first character to grab hold of the staff must make a DC 28 Fortitude basic saving throw, taking 24 (2d10+13) electricity damage on a failed save. If the character releases the staff, it vanishes. If this occurs, the runes cannot be activated again for one year.
...
At the end of each turn the character continues to hold the staff, they can make a DC 28 Will saving throw to resist and control the staff’s magic. Depending on how far the staff’s energy has progressed into the character’s body, the following effects then occur, with the arcane surge beginning at the player's hand:

| Arcane Surge | Success                                                                   | Failure                                                                                       |
| :----------: | :------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------- |
|     Hand     | The arcane surge ends and the player can immediately attune to the staff. | The player takes 1d8 force damage and the staff’s energy progresses to the player’s arm.      |
|     Arm      | The staff’s energy recedes to the player’s hand.                          | The player takes 1d8 force damage and the staff’s energy progresses to the player’s shoulder. |
|   Shoulder   | The staff’s energy recedes to the player’s arm.                           | The player takes 2d8 force damage and the staff’s energy progresses to the player’s chest.    |
|    Chest     | The staff’s energy recedes to the player’s shoulder.                      | The player takes 8d10 force damage.                                                           |
...
> [!item]+ **Khazan's Staff - Level 13**
> *staff, unique, magical, artifact, mythic*
>
> I suggest making it [Staff of Arcane Might - Level 12](https://2e.aonprd.com/Equipment.aspx?ID=3038) but with a change that it deals 2d8 force damage per charge and is DC 35 when destroyed.
### Sergei’s Tomb
<span class="citation"><em>This scene takes place in Chapter 4, Area K85.</em></span>

This area is largely as described in <span class="citation">K85. Sergei’s Tomb (p. 93)</span>. DC 35 Athletics check is required to lift a portcullis. The coffin can be opened by a touch of a Holy creatures. Alternatively, it can be opened with a DC 26 Athletics check.
However, Sergei’s armor is nonmagical and ceremonial, rather than practical, and cannot be used as plate armor.
...
This row of crypts is largely as described in <span class="citation">Crypt 24 (p. 90)</span>, <span class="citation">Crypt 25 (p. 90)</span>, <span class="citation">Crypt 26 (p. 90)</span>, <span class="citation">Crypt 27 (p. 90)</span>, <span class="citation">Crypt 28 (p. 90)</span>, and <span class="citation">Crypt 29 (p. 91)</span>.

***Crypt 27.*** Remove the **giant wolf spiders** from the crypt.
***Crypt 28.*** DC 27 Perception (Expert) to notice a dangerous magic around the bell.
DC 29 Reflex basic saving throw - (35) 4d10+13 fire damage plus 2d8 persistent fire damage. Spork can be replaced with [Waffle Iron (Mithral)](https://2e.aonprd.com/Equipment.aspx?ID=1403).
***Crypt 29.*** Use [Brown Mold scaled to Level 6](https://2e.aonprd.com/Hazards.aspx?ID=35). Also, replace the *luck blade* with a [Luck Blade but +2 striking and Level 11 instead](https://2e.aonprd.com/Equipment.aspx?ID=390).
#### South Crypts, Second Row
This row of crypts is largely as described in <span class="citation">Crypt 30 (p. 91)</span>, <span class="citation">Crypt 31 (p. 91)</span>, <span class="citation">Crypt 32 (p. 91)</span>, <span class="citation">Crypt 33 (p. 91)</span> and <span class="citation">Crypt 34 (p. 92)</span>.

***Crypt 30.*** Unholy touch produces a 3d10 holy spirit damage burst.
***Crypt 31.*** The spell scroll is [Circle of Protection 4th Rank](https://2e.aonprd.com/Spells.aspx?ID=38).
#### Crypt 31's Pit Trap - Hazard 8
_Simple, Trap_
**Complexity** Simple
**Stealth** DC 26 (expert)

**Disable**
DC 28 Thievery (expert) to disable the trap.

**Pitfall - ↻** **Trigger** A creature moves onto the leaf-covered hide;
**Effect** The triggering creature falls in and takes falling damage (15 bludgeoning damage) and is targeted by a spike's Strike. A falling creature can attempt to Grab an Edge with a DC 26 Reflex save.
**Melee - ▶** spike +23, **Damage** 4d10+22	piercing

---
***Crypt 33.*** Revise the epigraph on Crypt 33 to read “St. Finderway, Saint of Lost Travelers," and replace Sir Klutz’s remains with a set of human bones lying beside an *orb of direction* (<span class="citation">Xanathar’s Guide to Everything, p. 138</span>) hanging from a leather cord.
When you hold this sphere, you can spend an action to identify the northern direction. This ability only works while on the Material Plane.

***Crypt 34.*** Remove the **imp**, and place the *Spear of the Huntress* inside of the sarcophagus there.

> [!item]+ **Spear of the Huntress**
> This six-foot shaft of ash wood is adorned with carvings of wild animals, vines, and leaves, and bears a simple, yet sharp stone head. When first recovered from Dostron’s sarcophagus, it has the next properties:
>  - The traits are [Unique](https://2e.aonprd.com/Traits.aspx?ID=723) [Backswing](https://2e.aonprd.com/Traits.aspx?ID=173) [Finesse](https://2e.aonprd.com/Traits.aspx?ID=179) [Reach](https://2e.aonprd.com/Traits.aspx?ID=192) [Sweep](https://2e.aonprd.com/Traits.aspx?ID=194) [Versatile S](https://2e.aonprd.com/Traits.aspx?ID=200)
>  - **Damage** 1d6 P; **Hands** 2; **Bulk** 1
>  - **Type** Melee; **Category** Martial; **Group** [Spear](https://2e.aonprd.com/WeaponGroups.aspx?ID=14)
>  - It is a special [Wounding](https://2e.aonprd.com/Equipment.aspx?ID=2854) [Bloodthirsty](https://2e.aonprd.com/Equipment.aspx?ID=1297) weapon
> If you are holy, you are enfeebled 2 while carrying or wielding this weapon.
>
> (The spear was corrupted long ago by the influence of Kavan and the Devourer, and can be restored in [[Arc T - The Three Fanes]] by either communing with the spirit of the Huntress, or reconsecrating the Forest Fane at Yester Hill, which the players can learn about at the Mountain Folk settlement of Soldav in [[Arc R - Trials of the Mountain]].)
#### South Crypts, Third Row
This row of crypts is largely as described in <span class="citation">Crypt 35 (p. 92)</span>, <span class="citation">Crypt 36 (p. 92)</span>, <span class="citation">Crypt 37 (p. 92)</span>, <span class="citation">Crypt 38 (p. 92)</span>, <span class="citation">Crypt 39 (p. 93)</span>, and <span class="citation">Crypt 40 (p. 93)</span>.



***Crypt 35.*** Use five [Ghoul Stalker scaled to Level 5](https://2e.aonprd.com/Monsters.aspx?ID=3009). The [Silence](https://2e.aonprd.com/Spells.aspx?ID=1674) is 4th rank. The [Illusory Object](https://2e.aonprd.com/Spells.aspx?ID=1569) is 5th rank. [Counteract](https://2e.aonprd.com/Rules.aspx?ID=371) and [Disbelieve Illusion](https://2e.aonprd.com/Rules.aspx?ID=267) DC 26.

> [!combat]- **Balancing the Thirty-Fifth Crypt**
> This combat encounter is a **Moderate** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
> * **Three Players**. Reduce the number of ghouls to 4.
> * **Five Players**. Increase the number of ghouls to 6.
> * **Six Players**. Increase the number of ghouls to 7.

***Crypt 37.*** The damage is (26) 4d12 electricity damage. The spell scrolls are [Howling Blizzard](https://2e.aonprd.com/Spells.aspx?ID=1559), [Fireball](https://2e.aonprd.com/Spells.aspx?ID=1530), [Lightning Bolt](https://2e.aonprd.com/Spells.aspx?ID=1586).

***Crypt 38.*** The hell hounds and General Grislek’s wraith do not emerge from the crypt when it is first opened.

***Crypt 39.*** Beucephalus cannot be found in the crypt at this time.

Finally, move the invisible teleport traps described in Teleport Traps (p. 85) to the base of the stairs in Strahd’s tomb (see below).

***Crypt 40.*** Replace the epigraph and contents of Crypt 40 with the epigraph and contents of <span class="citation">Crypt 6 (p. 86)</span>, including the **poison dart trap** protecting it. Use [Poisoned Dart Gallery](https://2e.aonprd.com/Hazards.aspx?ID=492). In addition, replace Saint Markovia’s thighbone with the *Icon of Dawn’s Grace* (see below), and remove the whispered message from Saint Markovia’s spirit.
...
>
> ***Protection from Evil.*** You can present the icon as an action to grant yourself and each creature within 30 feet of you the effect of a *[Circle of Protection](https://2e.aonprd.com/Spells.aspx?ID=38)* spell against fiends and undead. Once used, this property can’t be used again until the next dawn.
>
> Also, it can cast [Augury](https://2e.aonprd.com/Spells.aspx?ID=1445) once per day.
> If you use it as a holy symbol for [Panic the Dead](https://2e.aonprd.com/Feats.aspx?ID=4650) the DC is 2 higher.
> And you can cast [Heal 3rd rank](https://2e.aonprd.com/Spells.aspx?ID=1554) once per day.
>
...
> Due to the phase mechanic, this combat encounter is a series of two consecutive **Severe** combat encounters against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir).
>
> The initial campaign suggests to make it pretty difficult encounter. If you think your party is ready for this, give him Heroism (5th rank) or just scale his stat blocks to Level 12.
>
> For parties of smaller or larger sizes, modify the encounter as follows:
> * Three Players. Apply Weak to the first phase.
> * Four Players. Apply Elite to the second phase.
> * Six Players. Apply Elite to both phases.
...
> * The **skeletons** in <span class="citation">Crypt 2 (p. 86)</span>, <span class="citation">Crypt 3 (p. 86)</span>, <span class="citation">Crypt 5 (p. 86)</span>, <span class="citation">Crypt 2 (p. 86)</span>, <span class="citation">Crypt 8 (p. 87)</span>, <span class="citation">Crypt 9 (p. 87)</span>, <span class="citation">Crypt 10 (p. 87)</span>, <span class="citation">Crypt 13 (p. 88)</span>, <span class="citation">Crypt 16 (p. 89)</span>, <span class="citation">Crypt 17 (p. 89)</span>, <span class="citation">Crypt 19 (p. 89)</span>, <span class="citation">Crypt 24 (p. 90)</span>, <span class="citation">Crypt 25 (p. 90)</span>, <span class="citation">Crypt 26 (p. 90)</span>, <span class="citation">Crypt 28 (p. 90)</span>, <span class="citation">Crypt 30 (p. 91)</span>, <span class="citation">Crypt 33 (p. 91)</span>, <span class="citation">Crypt 36 (p. 92)</span>, and <span class="citation">Crypt 37 (p. 92)</span> animate. The following round, each skeleton emerges from its crypt, pursuing and attacking any intruders on sight. (Skeletons without weapons can make only unarmed strikes and grapples.) Use [Skeleton Infantry](https://2e.aonprd.com/Monsters.aspx?ID=1300)  stat block, it has only half HP.
> * All one hundred **skeletons** in <span class="citation">Crypt 14 (p. 88)</span> animate. Over the following three rounds, the skeletons form a living ladder, allowing any remaining **[Elite Cairn Wights](https://2e.aonprd.com/Monsters.aspx?ID=859)** in the vault to climb from the shaft and emerge from the crypt, pursuing and attacking any intruders on sight. Use [Skeleton Infantry](https://2e.aonprd.com/Monsters.aspx?ID=1300)  for skeletons. 2d6+13 HP of armed **skeletons** emerge from the crypt each subsequent round, until all skeletons have emerged.
> * On initiative count 20 of the third round after the amulet is activated, three **[Greater Hell Hounds scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=3048)** and **[Mythic Wight Commander scaled down to Level 10](https://2e.aonprd.com/Monsters.aspx?ID=1917)** described in <span class="citation">Crypt 38 (p. 92)</span> begin to manifest in their crypt, coalescing fully from brimstone smoke three rounds later. They then emerge to pursue any intruders still remaining in the catacombs or [[#P11g. Catacomb Tunnel]]. If they were slain because the players reached 15 APs threshold, instead - **[Dread Wraith scaled to Level 11](https://2e.aonprd.com/Monsters.aspx?ID=865)** manifests - the last remnant of General Grislek's dark will.
> * The **[Iron Wardens scaled down to Level 11](https://2e.aonprd.com/Monsters.aspx?ID=3068)** in <span class="citation">K78. Brazier Room (p. 82)</span> begin to animate, activating fully on initiative count 20 of the fifteenth round after the amulet is activated. (Creatures in the Brazier Room while the golems are activating can observe their limbs and heads slowly grinding to life, their lifeless gazes locking onto any intruders present in their chamber.)
> * The **[Mythic Weak Young Red Dragon](https://2e.aonprd.com/Monsters.aspx?ID=136)** statues in the [[#Main Entrance]], as well as any remaining **gargoyles** in the [[#Main Foyer]] and any remaining **[Hunter Wights](https://2e.aonprd.com/Monsters.aspx?ID=1915)** still guarding the castle walls (see [[#P2d. Crossing the Chasm]]), animate and begin moving toward the amulet’s wielder.
>
...
This area is largely as described in <span class="citation">K86. Strahd’s Tomb (p. 93)</span>. DC 35 Athletics check is required to lift a portcullis. However, the teleport traps described in <span class="citation">Teleport Traps (p. 85)</span> form a protective ring around the base of the staircase that descends into the tomb, rather than around the entrance to the tomb. In addition, replace the three vampiric brides buried in the earth near the east wall with three anonymous **[Mythic Vampire Servitors scaled to Level 7](https://2e.aonprd.com/Monsters.aspx?ID=3224)** created from ordinary Barovians.

> [!combat]- **Balancing the Tomb of the Darklord**
> This combat encounter is a **Moderate** combat encounter against a party of four 8th-level players, a Level 6 ally (Ireena Kolyana), and a Level 7 ally (Ezmerelda d’Avenir). For parties of smaller or larger sizes, modify the encounter as follows:
>
> * **Three Players**. Reduce the number of vampire spawn to 2.
> * **Five Players**. Increase the number of vampire spawn to 4.
> * **Six Players**. Reduce the number of vampire spawn to 5.

Strahd’s coffin is surrounded by a 5-foot-radius *[Antimagic Field](https://2e.aonprd.com/Spells.aspx?ID=14)* effect identical to the one described in <span class="citation">Khazan’s Spell Drain (p. 167)</span>. The effect doesn’t apply to spells cast by a creature attuned to *Khazan's Staff*, which is hidden in <span class="citation">Crypt 15 (p. 88)</span> in [[#North Crypts, Third Row]].
